    ...
    public static void main(String[] args) 
{
        ...
        LinkedList store = new LinkedList();//declares a new queue object
        ...
        for (int i = 1; i <= 60; i++)
        {
            if (rand.nextInt(4) + 1 == 1)//randomly gives a 25% probability of a customer popping up
            {
                ...
                store.addQueue(new Customer());//adds new customer to queue 
                
                System.out.println("New customer added! Queue length is now " + store.getLength());
                System.out.println("------------------------------------------------------------");
            
                //store the max length during 60 min
                if (store.getLength() > max) 
                {
                    max++;
                }
            }
            ...
            {
                Customer customer = store.getFirst();
                ...
                if (customer.getServiceTime() <= 0) 
                {
                    ...
                    System.out.println("Customer serviced and removed from the queue. Queue length is now: " + store.getLength());
                    System.out.println("------------------------------------------------------------");
                }
                else
                {
